...
func obstacleBase(islandID int64) int {
	...
	// you dont have to put -1 for later islands, like if you wanted mirror islands you could either change 
	// case 1:
	// to
	// case 1, 101:
	// or just have case 101: straight up for unique obstacles
